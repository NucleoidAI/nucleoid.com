...
export const _descriptions = [
  `The Nucleoid Project facilitates the development of Neuro-Symbolic AI systems by enabling AI systems to learn from data and reason through logic simultaneously.`,
